{{-- Show cars added by the authenticated user --}}
...
<div class="container my-5 text-white">
	<div class="text-center mb-5">
		<h1 class="fw-bold display-5 text-white">MY <span class="text-warning">CARS</span></h1>
		<p class="text-secondary">Cars added by {{ $user->name }}.</p>
	</div>
				...
				<div class="card showroom-card rounded-4 h-100 shadow-sm overflow-hidden text-white">
					...
					<div class="card-body bg-black d-flex flex-column p-4">
						...
						<div class="d-flex justify-content-between align-items-center mt-auto pt-3 border-top border-secondary">
							...
							<a href="{{ route('cars.show', $car) }}" class="btn btn-outline-warning btn-sm px-3 fw-semibold">Details</a>
						</div>
					</div>
				</div>
			</div>
